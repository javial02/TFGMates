...
int main() {
    ...
    ifstream archivo("Calendario_modelo_8_equipos_con_numeros_solo_div.txt"); // Abre el archivo en modo lectura
    ...
    imprimeCalendario(viajes, "Heuristica_2_8eq_div.txt");
