...
int main() {
    ...
    ifstream archivo("Calendario_8eq_div.txt"); // Abre el archivo en modo lectura
    ...
    ofstream archivo2("Temple_simulado_h2_3_8eq_div.txt"); // Abre el archivo en modo lectura
    ...
    imprimeCalendario(mejor_calend, "TS_h2_3_8eq_div.txt");
