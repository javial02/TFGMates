...
int main() {
    ...
    ifstream archivo("resultados.txt"); // Abre el archivo en modo lectura
    ...
    while (t_inicial > 0.01) {
        ...
        //int M_actual = max(1, (int)(M * t_inicial / 100));
        ...
        cout << "Distancia tras cambios con T = " << t_inicial << " y M = " << M << ": " << distancia << endl;
    ...
    cout << "Mejor solución: " << distancia_mejor << endl;
    //archivo2 << "Mejor solución: " << distancia_mejor << endl;
