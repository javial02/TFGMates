...
int main() {
    ...
    ofstream archivo2("mejor_calendario_82.txt"); // Abre el archivo en modo lectura
    ...
    for (int i = 0; i < N; i++) {
        for (int k = 0; k < mejor_calend[0].size(); k++) {
            archivo2 << mejor_calend[i][k] << " ";
        }
    ...
    imprimeCalendario(mejor_calend, "Mejor_VNS.txt");
